...
# manimgl example_scenes.py SurfaceExample, font='SimHei', font='Microsoft JhengHei'
class SurfaceExample(Scene):
    ...
    def construct(self):
        surface_text = Text("For 3d scenes, try using surfaces哈哈", font='Microsoft JhengHei')
