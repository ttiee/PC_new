    ...
    while True:
        ...
        if rev["post_type"] == "message":
            ...
            if rev["message_type"] == "private":  # 私聊
                ...
                qq = rev['sender']['user_id']
                if group == 1143107466:
                    m = shenqi_ai(rev['raw_message'])
                    msg = {'msg_type': 'group', 'number': 1143107466, 'msg': m}
                    send_msg(msg)
                elif group == 643272204 or group == 762093001:
                    ...
                    send_msg({'msg_type': 'group', 'number': group,
                              'msg': mus1.format(_id[random.randint(0, 6)])})
