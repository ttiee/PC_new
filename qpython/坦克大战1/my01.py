    ...
    def getEvent(self):
        ...
        for event in eventList:
            ...
            if event.type == pygame.KEYDOWN:
               ...
               if MainGame.my_tank and MainGame.my_tank.live:
                   ...
                   if event.key == pygame.K_LEFT or event.key == pygame.K_4:
                       ...
                       # MainGame.my_tank.move()
                       print('按下左键，坦克向左移动')
                   elif event.key == pygame.K_RIGHT or event.key == pygame.K_6:
                       # 切换方向
                       ...
                       # MainGame.my_tank.move()
                       print('按下上键，坦克向上移动')
                   elif event.key == pygame.K_DOWN or event.key == pygame.K_8:
                       # 切换方向
                       ...
                       if len(MainGame.myBulletList) < 100:
                           # 创建我方坦克发射的子弹
            ...
            if event.type == pygame.KEYUP:
                ...
                if event.key==pygame.K_UP or event.key==pygame.K_DOWN or event.key == pygame.K_LEFT or event.key ==pygame.K_RIGHT or event.key == pygame.K_3:
                    if  MainGame.my_tank and MainGame.my_tank.live:
