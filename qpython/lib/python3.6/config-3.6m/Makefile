...
MODNAMES=        _thread posix errno pwd _sre _codecs _weakref _functools _operator _collections itertools atexit _signal _stat time _locale _io zipimport faulthandler _tracemalloc _symtable binascii parser zlib pyexpat _multibytecodec _codecs_cn _codecs_hk _codecs_iso2022 _codecs_jp _codecs_kr _codecs_tw xxsubtype
MODOBJS=          Modules/_threadmodule.o  Modules/posixmodule.o  Modules/errnomodule.o  Modules/pwdmodule.o  Modules/_sre.o  Modules/_codecsmodule.o  Modules/_weakref.o  Modules/_functoolsmodule.o  Modules/_operator.o  Modules/_collectionsmodule.o  Modules/itertoolsmodule.o  Modules/atexitmodule.o  Modules/signalmodule.o  Modules/_stat.o  Modules/timemodule.o  Modules/_localemodule.o  Modules/_iomodule.o Modules/iobase.o Modules/fileio.o Modules/bytesio.o Modules/bufferedio.o Modules/textio.o Modules/stringio.o  Modules/zipimport.o  Modules/faulthandler.o  Modules/_tracemalloc.o Modules/hashtable.o  Modules/symtablemodule.o  Modules/binascii.o  Modules/parsermodule.o  Modules/zlibmodule.o  Modules/xmlparse.o Modules/xmlrole.o Modules/xmltok.o Modules/pyexpat.o  Modules/multibytecodec.o  Modules/_codecs_cn.o  Modules/_codecs_hk.o  Modules/_codecs_iso2022.o  Modules/_codecs_jp.o  Modules/_codecs_kr.o  Modules/_codecs_tw.o  Modules/xxsubtype.o
...
abs_srcdir=	/home/QPY/qpython3-core/python-3.6.1
abs_builddir=	/home/QPY/qpython3-core/python-3.6.1
...
BASECPPFLAGS=	
CONFIGURE_CFLAGS=	-DANDROID -mandroid  -fomit-frame-pointer --sysroot /home/QPY/android-ndk-r14b/platforms/android-14/arch-arm -I /home/QPY/android-ndk-r14b/platforms/android-14/arch-arm/user/include -I/home/QPY/qpython3-core/thirdparty/include -I/home/QPY/qpython3-core/thirdparty/include/ncurses
...
CONFIGURE_CPPFLAGS=	
CONFIGURE_LDFLAGS=	-L/home/QPY/android-ndk-r14b/platforms/android-14/arch-arm/usr/lib  --sysroot /home/QPY/android-ndk-r14b/platforms/android-14/arch-arm -g -L/home/QPY/qpython3-core/thirdparty/lib
...
CONFIG_ARGS=	 '--host=arm-linux-androideabi' '--build=x86_64-linux-gnu' '--prefix=/python' '--enable-shared' '--disable-ipv6' 'build_alias=x86_64-linux-gnu' 'host_alias=arm-linux-androideabi' 'CC=arm-linux-androideabi-gcc' 'CFLAGS=-DANDROID -mandroid  -fomit-frame-pointer --sysroot /home/QPY/android-ndk-r14b/platforms/android-14/arch-arm -I /home/QPY/android-ndk-r14b/platforms/android-14/arch-arm/user/include' 'LDFLAGS=-L/home/QPY/android-ndk-r14b/platforms/android-14/arch-arm/usr/lib  --sysroot /home/QPY/android-ndk-r14b/platforms/android-14/arch-arm -g'
...
Modules/parser$(EXT_SUFFIX):  Modules/parsermodule.o; $(BLDSHARED)  Modules/parsermodule.o   -o Modules/parser$(EXT_SUFFIX)
...
Modules/xmlparse.o: $(srcdir)/Modules/expat/xmlparse.c; $(CC) $(PY_CORE_CFLAGS)  -I$(srcdir)/Modules/expat -DHAVE_EXPAT_CONFIG_H -DUSE_PYEXPAT_CAPI -c $(srcdir)/Modules/expat/xmlparse.c -o Modules/xmlparse.o
Modules/xmlrole.o: $(srcdir)/Modules/expat/xmlrole.c; $(CC) $(PY_CORE_CFLAGS)  -I$(srcdir)/Modules/expat -DHAVE_EXPAT_CONFIG_H -DUSE_PYEXPAT_CAPI -c $(srcdir)/Modules/expat/xmlrole.c -o Modules/xmlrole.o
Modules/xmltok.o: $(srcdir)/Modules/expat/xmltok.c; $(CC) $(PY_CORE_CFLAGS)  -I$(srcdir)/Modules/expat -DHAVE_EXPAT_CONFIG_H -DUSE_PYEXPAT_CAPI -c $(srcdir)/Modules/expat/xmltok.c -o Modules/xmltok.o
Modules/pyexpat.o: $(srcdir)/Modules/pyexpat.c; $(CC) $(PY_CORE_CFLAGS)  -I$(srcdir)/Modules/expat -DHAVE_EXPAT_CONFIG_H -DUSE_PYEXPAT_CAPI -c $(srcdir)/Modules/pyexpat.c -o Modules/pyexpat.o
Modules/pyexpat$(EXT_SUFFIX):  Modules/xmlparse.o Modules/xmlrole.o Modules/xmltok.o Modules/pyexpat.o; $(BLDSHARED)  Modules/xmlparse.o Modules/xmlrole.o Modules/xmltok.o Modules/pyexpat.o   -o Modules/pyexpat$(EXT_SUFFIX)
Modules/multibytecodec.o: $(srcdir)/Modules/cjkcodecs/multibytecodec.c; $(CC) $(PY_CORE_CFLAGS)  -c $(srcdir)/Modules/cjkcodecs/multibytecodec.c -o Modules/multibytecodec.o
Modules/_multibytecodec$(EXT_SUFFIX):  Modules/multibytecodec.o; $(BLDSHARED)  Modules/multibytecodec.o   -o Modules/_multibytecodec$(EXT_SUFFIX)
...
Modules/_codecs_cn$(EXT_SUFFIX):  Modules/_codecs_cn.o; $(BLDSHARED)  Modules/_codecs_cn.o   -o Modules/_codecs_cn$(EXT_SUFFIX)
...
Modules/_codecs_hk$(EXT_SUFFIX):  Modules/_codecs_hk.o; $(BLDSHARED)  Modules/_codecs_hk.o   -o Modules/_codecs_hk$(EXT_SUFFIX)
...
Modules/_codecs_iso2022$(EXT_SUFFIX):  Modules/_codecs_iso2022.o; $(BLDSHARED)  Modules/_codecs_iso2022.o   -o Modules/_codecs_iso2022$(EXT_SUFFIX)
...
Modules/_codecs_jp$(EXT_SUFFIX):  Modules/_codecs_jp.o; $(BLDSHARED)  Modules/_codecs_jp.o   -o Modules/_codecs_jp$(EXT_SUFFIX)
...
Modules/_codecs_kr$(EXT_SUFFIX):  Modules/_codecs_kr.o; $(BLDSHARED)  Modules/_codecs_kr.o   -o Modules/_codecs_kr$(EXT_SUFFIX)
...
Modules/_codecs_tw$(EXT_SUFFIX):  Modules/_codecs_tw.o; $(BLDSHARED)  Modules/_codecs_tw.o   -o Modules/_codecs_tw$(EXT_SUFFIX)
