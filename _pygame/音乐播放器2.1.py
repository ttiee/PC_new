...
class MainMusicPlayer:
    ...
    def __init__(self):
        self.music = None
        self.color_num = 'bold'    # 音乐序号颜色
        self.color_music_name = 'normal'    # 音乐颜色
        self.color_quit = 'red'    # 退出颜色
        self.color_events = '#FFFAFA'   # 指令颜色
        self.volume = 100   # 记录音量
        self.play_methods = 0   # 0普通播放 1单曲循环 2随机播放
        self.loops = 1  # 音乐循环次数，0为单曲循环
    ...
    def play_events(self, music_dic):
        # self.music = Music.get_filename()    # 取消注释可以正常显示
        # self.volume = int(Music.get_volume() * 100)   # 取消注释可以正常显示
